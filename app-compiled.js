...
${eatenText} ${prefsText}
הצע 3 אפשרויות שונות ומגוונות למה שכדאי לאכול עכשיו (ארוחה או חטיף), תוך התחשבות במה שכבר נאכל (לגיוון, לא לחזור על אותו דבר).
חשוב מאוד: לכל אפשרות, הקלוריות חייבות להיות **קטנות או שוות** ל-${remaining.calories} (אסור לחרוג מהמספר הזה, גם במחיר שהמנה תהיה צנועה או שהמאקרו לא יתאזן במדויק). עדיף הצעה קטנה וריאלית מהצעה שחורגת מהתקציב.
לכל אפשרות תן שם קצר וברור בעברית וערכים תזונתיים.
החזר אך ורק מערך JSON תקין, בלי שום טקסט נוסף, בפורמט הזה בדיוק:
